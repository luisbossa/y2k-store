class Slider {
  constructor(cont, opt) {
    this.controls = [...document.getElementsByClassName("ctrlbtn")];
  ...
  doThings() {
    ...
    this.plane
      .onLoading((tex) => {
        tex.setMinFilter(this.curtains.gl.LINEAR_MIPMAP_NEAREST);
      })
      .onReady(() => {
      ...
      .onRender(() => {
        ...
        tempTime *= 1 + this.state.timer * this.shaderPicker.timerMultiplier;
