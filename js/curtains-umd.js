  ...
  var a = (function () {
      function e(t) {
        (_classCallCheck(this, e),
          (this.type = "Scene"),
          t && "Renderer" === t.type
            ? t.gl || r(this.type + ": Renderer WebGL context is undefined", t)
          ...
          },
          {
            ...
            value: function (e) {
              "PingPongPlane" === e.type
                ...
                : e.target
                  ? (this.stacks.renderTargets =
                      this.stacks.renderTargets.filter(function (t) {
                        return t.uuid !== e.uuid;
                      }))
                  : e._transparent
          ...
          },
          {
            ...
            value: function (e) {
              return this.textures.find(function (t) {
                return t.source && t.source.src === e.src && t.uuid != t.uuid;
              });
            },
          },
          {
    ...
    l = (function () {
      function e(t) {
        ...
        if (
          ((this.gl = this.canvas.getContext("webgl2", y)),
          (this._isWebGL2 = !!this.gl),
          this.gl ||
            (this.gl =
              this.canvas.getContext("webgl", y) ||
              this.canvas.getContext("experimental-webgl", y)),
          !this.gl)
        )
          return (
            this.production ||
            ...
            value: function () {
              if (
                ...
                return (
                  ...
                  i(
                    this.type +
                      ": Will use default vertex and fragment shaders",
                  ),
                  (this.vertexShader = this.createShader(
                    this.defaultVsCode,
                    this.gl.VERTEX_SHADER,
      ...
      return (
        _createClass(e, [
          ...
          },
          {
            ...
            value: function (e) {
              return (
                this.applyMat4(e.viewMatrix).applyMat4(e.projectionMatrix),
                this
              );
            },
          },
    ...
    C = (function () {
      function e(t) {
        ...
        if (
          ...
          (this._samplerName = d),
          (this._sampler = { isActive: !1, isTextureBound: !1 }),
          (this._textureMatrix = { matrix: new k(), isActive: !1 }),
        ...
        _createClass(e, [
          ...
          },
          {
            ...
            value: function (e) {
              ...
              var r = this.renderer.cache.getTextureFromSource(e);
              if (r)
                return (
                  this._uploaded ||
                    (this.renderer.nextRender.add(function () {
          ...
          },
          {
            ...
            value: function () {
              ...
              var e = this._parent.scale
                  ? w.set(this._parent.scale.x, this._parent.scale.y)
                  : w.set(1, 1),
          ...
          },
          {
            ...
            value: function (e) {
              e.type && "Vec2" === e.type
                ? (e.sanitizeNaNValuesWith(this.scale).max(w.set(0.001, 0.001)),
          ...
          },
          {
            ...
            value: function (e) {
              ...
              ((t.x /= this.scale.x),
                (t.y /= this.scale.y),
                (this._textureMatrix.matrix = S.setFromArray([
                  t.x,
                  0,
                  0,
                  0,
              ...
              return (
                "string" == typeof e
                  ? null !==
                    ...
                    ? (t = "image")
                    : null !== e.match(/\.(webm|mp4|ogg|mov)$/) && (t = "video")
                  : "IMG" === e.tagName.toUpperCase()
                    ? (t = "image")
                    : "VIDEO" === e.tagName.toUpperCase()
                      ? (t = "video")
          ...
          },
          {
            ...
            value: function (e) {
              var t =
                ...
                s = this._createImage(e),
                n = Object.assign(t, {});
              (this._parent &&
                (n = Object.assign(n, this._parent._texturesOptions)),
                (n.loader = this),
                (n.sampler = s.getAttribute("data-sampler") || n.sampler));
              var a = this.renderer.cache.getTextureFromSource(s);
              if (a) {
                n.fromTexture = a;
                var o = new C(this.renderer, n);
                return (
                  i && i(o),
                  void (this._parent && this._addToParent(o, s, "image"))
                );
              }
              var h = new C(this.renderer, n),
                l = this._addElement(s, h, i, r);
              (s.complete
                ? this._sourceLoaded(s, h, i)
                : s.decode
                  ? s
                      .decode()
                      .then(this._sourceLoaded.bind(this, s, h, i))
                      .catch(function () {
                        (s.addEventListener("load", l.load, !1),
                          s.addEventListener("error", l.error, !1));
                      })
                  : (s.addEventListener("load", l.load, !1),
                    s.addEventListener("error", l.error, !1)),
                this._parent && this._addToParent(h, s, "image"));
            },
          },
          {
            key: "loadImages",
          ...
          },
          {
            ...
            value: function (e) {
              ...
              (this._parent &&
                ...
                (r.loader = this),
                (r.sampler = e.getAttribute("data-sampler") || r.sampler));
              var s = new C(this.renderer, r);
    ...
    A = (function () {
      function e(t) {
        ...
        (_classCallCheck(this, e),
          ...
          (p = parseInt(p)),
          (g = parseInt(g)),
          (this._geometry = new b(this.renderer, { width: p, height: g })),
          (this._program = new x(this.renderer, {
            parent: this,
            vertexShader: h,
            fragmentShader: l,
          })),
        ...
        _createClass(e, [
          {
            ...
            value: function () {
              var e = this;
              ((this.uuid = s()),
                (this.loader = new M(this.renderer, this, {
                  sourcesLoaded: 0,
                  initSourcesToLoad: 0,
                  complete: !1,
                  onComplete: function () {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.loader.loadSource(
                e,
                Object.assign(this._texturesOptions, r),
                function (e) {
                  s && s(e);
                },
                function (e, r) {
          ...
          },
          {
            ...
            value: function (e) {
              ...
              this.loader.loadCanvas(
                e,
                Object.assign(this._texturesOptions, t),
                function (e) {
                  i && i(e);
                },
              );
      ...
      return (
        _createClass(r, [
          ...
          },
          {
            ...
            value: function (e) {
              var t = this.scale ? this.scale : O.set(1, 1),
                i = F.set(
                  (this._boundingRect.document.width -
                ...
                a =
                  ...
                  this.renderer.pixelRatio;
              return F.set(((e.x - a) / r) * 2 - 1, 1 - ((e.y - n) / s) * 2);
            },
          },
          {
            key: "onAfterResize",
    ...
    $ = (function (e) {
      ...
      function r(e, i) {
        var s,
          ...
          R = n.transparent,
          P = void 0 !== R && R,
          w = n.drawCheckMargins,
          T = void 0 === w ? { top: 0, right: 0, bottom: 0, left: 0 } : w,
          S = n.autoloadSources,
          C = void 0 === S || S,
          E = n.watchScroll,
          M = void 0 === E || E,
        ...
        return (
          ...
          ((s = t.call(this, e, i, "Plane", {
            ...
            texturesOptions: m,
            crossOrigin: v,
          })).index = s.renderer.planes.length),
          (s.target = null),
          (s.alwaysDraw = x),
          (s._shouldDraw = !0),
          (s.visible = k),
          (s._transparent = P),
          (s.drawCheckMargins = T),
          (s.autoloadSources = C),
          (s.watchScroll = M),
          (s._updateMVMatrix = !1),
          (s.camera = new z({
      ...
      return (
        _createClass(r, [
          ...
          },
          {
            ...
            value: function (e) {
              e.type && "Vec2" === e.type
                ? (e.sanitizeNaNValuesWith(this.scale).max(U.set(0.001, 0.001)),
          ...
          },
          {
            ...
            value: function () {
              ...
              if (this.autoloadSources) {
                for (
                  var t = [], i = 0;
                  i < this.htmlElement.getElementsByTagName("img").length;
                  i++
                )
                  t.push(this.htmlElement.getElementsByTagName("img")[i]);
                t.length > 0 && this.loadImages(t);
                for (
                  var r = [], s = 0;
                  s < this.htmlElement.getElementsByTagName("video").length;
                  s++
                )
                  r.push(this.htmlElement.getElementsByTagName("video")[s]);
                ...
                for (
                  ...
                  n.push(this.htmlElement.getElementsByTagName("canvas")[a]);
                (n.length > 0 && this.loadCanvases(n),
                  (e = t.length + r.length + n.length));
              }
          ...
          },
          {
            ...
            value: function (e) {
              if (
                (H.setAxisOrder(this.quaternion.axisOrder),
                H.equals(this.quaternion) && Y.equals(this.transformOrigin))
              )
                return _get(
          ...
          },
          {
            ...
            value: function () {
              ...
              this.textures.length)
                ...
                : new C(this.renderer, this._texturesOptions).addParent(this);
    ...
    te = (function (e) {
      ...
      function i(e) {
        ...
        return (
          ...
          (r.target = b),
          r.target &&
            ((r._isScenePass = !1), (r._shouldClear = r.target._shouldClear)),
          r._program.compiled &&
            (r._initShaderPass(),
      ...
      function i(e, r) {
        ...
        (_classCallCheck(this, i),
          ...
          (s = t.call(this, e, r, {
            ...
            watchScroll: w,
            fov: T,
          })).renderer.scene.removePlane(_assertThisInitialized(s)),
        ...
        _createClass(i, [
          {
            key: "_checkIfReady",
            value: function (e) {
              2 === e && this.textures[0].copy(this.target.getTexture());
            },
          },
          {
            key: "_swapPasses",
